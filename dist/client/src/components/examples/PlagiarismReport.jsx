...
export default function PlagiarismReportExample() {
    ...
    return (<div className="max-w-4xl mx-auto p-6">
      <PlagiarismReport fileName="Research_Paper_Final.docx" overallSimilarity={32} wordCount={2847} uniqueWords={1923} matches={mockMatches} onViewDetails={handleViewDetails} processingTime={3.7}/>
    </div>);
}
